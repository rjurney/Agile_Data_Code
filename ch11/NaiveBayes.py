...
if __name__ == "__main__":
    ...
    carresult, carprob = classify(carmodel, ['Red', 'Sports', 'Domestic'])
    print 'Is Yes?', carresult, carprob
    carresult, caprob = classify(carmodel, ['Red', 'SUV', 'Domestic'])
    print 'Is No?', carresult, carprob